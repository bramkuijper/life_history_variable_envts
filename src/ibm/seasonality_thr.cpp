...
void write_data()
{
    ...
    for (size_t i =  0; i < Nnonrep; ++i)
    {
        ...
        p = 1.0 / (1.0 + exp(
                    - (NonRep[i].a_tau[0] + NonRep[i].a_tau[1] * thr(NonRep[i].b_tau[0] + NonRep[i].b_tau[1],NonRep[i].ntime)) 
    ...
    for (size_t i =  0; i < Nrep; ++i)
    {
        ...
        p = 1.0 / (1.0 + exp(
                    - (Rep[i].a_tau[0] + Rep[i].a_tau[1] * thr(Rep[i].b_tau[0] + Rep[i].b_tau[1],Rep[i].ntime))
...
void reproduce()
{
    ...
    for (int nonrep_i = 0; nonrep_i < Nnonrep; ++nonrep_i)
    {
        p = 1.0/(1.0 + 
                exp( 
                    - (NonRep[nonrep_i].a_tau[0] + NonRep[nonrep_i].a_tau[1] * thr(NonRep[nonrep_i].b_tau[0] + NonRep[nonrep_i].b_tau[1],NonRep[nonrep_i].ntime))
